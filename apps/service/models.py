...
class Event(models.Model):
    ...
    other_name = models.CharField(
        max_length=250, blank=True, null=True, verbose_name="Other Details"
    )

    minister = models.CharField(max_length=50, blank=True, null=True)

    message = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="Message Title"
    )
    ...
    total_service_count = models.PositiveIntegerField(
        default=1, verbose_name="Service No"
    )
