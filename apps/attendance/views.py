...
class AttendanceViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        self.obj = serializer.save(count_coordinator=self.request.user, counting_index=FIRST_COUNTING)

        if event.double_counting:
            serializer.save(count_coordinator=self.request.user, counting_index=SECOND_COUNTING)
